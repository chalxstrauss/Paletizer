    ...
    public static class BarcodeConverter128
    {
        ...
        public static string StringToBarcode(string value)
        {
            ...
            if (value.Length > 0)
            {
                ...
                for (int charCount = 0; charCount < value.Length; charCount++)
                {
                    ...
                    if (!((currentChar >= 32 && currentChar <= 126) || currentChar == 203 || currentChar == 207))
                    {
                        isValid = false;
                        break;
                    }
                ...
                if (isValid)
                {
                    ...
                    while (charPos < value.Length)
                    {
                        if (isTableB)
                        {
                            ...
                            if (minCharPos < 0)
                            {
                                ...
                                if (charPos == 0)
                                {
                                    ...
                                    returnValue = ((char)210).ToString(); // char.ConvertFromUtf32(205);
                                }
                                else
                                {
                                    // Switch to table C
                                    returnValue = returnValue + ((char)204).ToString();
                                }
                                isTableB = false;
                            }
                            else
                            {
                                if (charPos == 0)
                                {
                                    ...
                                    returnValue = ((char)209).ToString(); // char.ConvertFromUtf32(204);
                                }
                        ...
                        if (!isTableB)
                        {
                            if ((int)char.Parse(value.Substring(charPos, 1)) == 207)
                            {
                                ...
                                if (minCharPos < 0) // OK for 2 digits, process it
                                {
                                    ...
                                    currentChar = currentChar < 95 ? currentChar + 32 : currentChar + 105;
                                ...
                                else
                                {
                                    ...
                                    returnValue = returnValue + ((char)205).ToString();
                                    isTableB = true;
                                }
                            }
                        }
                    ...
                    for (int loop = 0; loop < returnValue.Length; loop++)
                    {
                        ...
                        currentChar = currentChar < 127 ? currentChar - 32 : currentChar - 105;
                        if (loop == 0)
        ...
        private static int IsNumber(string InputValue, int CharPos, int MinCharPos)
        {
            ...
            if (CharPos + MinCharPos < InputValue.Length)
            {
                while (MinCharPos >= 0)
                {
                    if ((int)char.Parse(InputValue.Substring(CharPos + MinCharPos, 1)) < 48 || ((int)char.Parse(InputValue.Substring(CharPos + MinCharPos, 1)) > 57 && (int)char.Parse(InputValue.Substring(CharPos + MinCharPos, 1)) != 207))
                    {
                        break;
                    }
                    MinCharPos--;
